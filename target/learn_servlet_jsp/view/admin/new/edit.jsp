                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea
                                        id="content"
                                        name="content"
                                        style="width: 820px;height: 175px">${model.content}
                                </textarea>
                            </div>
                        </div>
                        <br/>
...
<script>
    ...
    $('#btnAddOrUpdateNew').click(function (event) {
        ...
        //lấy các giá trị từ name mà mình định nghĩa của từng cái xuống data
        ...
        //kiểu get của ckeditor, textarea
    ...
    //data mình gửi lên server có dajbg json
